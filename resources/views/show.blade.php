...
@section('content')
	<div class="movie-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			<div class="flex-none">
				<img src="/img/scoob!.jpg" alt="poster" class="w-64 lg:w-96">	
			</div>
			
			<div class="md:ml-24">
				<h2 class="text-4xl font-semibold">Scoob!</h2>
				...
				<div class="mt-12">
					<h4 class="text-media font-semibold">Featured Cast</h4>
					<div class="flex mt-4">
						<div>
	...
	<div class="movie-cast border-b border-gray-800">
		<div class="container mx-auto px-4 py-16">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
				<div class="mt-8">
					<a href="#">
						<img src="/img/scoob!.jpg" alt="actor" class="hover:opacity-75 transition ease-in-out duration-150">
					</a>
	...
	<div class="movie-image">
		<div class="container mx-auto px-4 py-16">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
				<div class="mt-8">
					<a href="#">
						<img src="/img/scoob!.jpg" alt="movie-image" class="hover:opacity-75 transition ease-in-out duration-150">
					</a>
				</div>
			</div>
